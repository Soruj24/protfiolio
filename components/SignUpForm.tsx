...
export function SignUpForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setSuccess("Welcome to my coding journey! You'll get updates about my latest projects.");
        setFormData({
          name: "",
          email: "",
          password: "",
          ...
          <CardHeader className="text-center space-y-4 pb-6">
            ...
            <div className="space-y-2">
              ...
              <CardDescription className="text-lg text-gray-600 dark:text-gray-400">
                Explore my projects and growth
              </CardDescription>
            </div>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                ...
                variant="outline"
                className="w-full h-12 border-2 border-dashed bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 hover:from-blue-100 hover:to-purple-100 dark:hover:from-blue-800/30 dark:hover:to-purple-800/30 transition-all duration-300 group border-blue-200 dark:border-blue-800"
              >
                <FolderGit2 className="w-5 h-5 mr-3 text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform" />
                <span className="font-semibold text-blue-700 dark:text-blue-300">View Public Projects</span>
              </Button>
            </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-start space-x-3 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                <Checkbox
                  ...
                  disabled={isLoading}
                  className="mt-1 data-[state=checked]:bg-blue-600 data-[state=checked]:border-blue-600 dark:data-[state=checked]:bg-blue-500 dark:data-[state=checked]:border-blue-500 border-gray-300 dark:border-gray-600"
                />
                <Label
                  htmlFor="terms"
                  className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer leading-relaxed"
                >
                  I&#39;d like to receive updates about new projects and coding journey insights.
                </Label>
              </div>
            ...
            <div className="text-center pt-6 border-t border-gray-200 dark:border-gray-700">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link
                  href="/auth/signin"
                  className="font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors underline underline-offset-4 flex items-center justify-center space-x-1"
                >
            ...
            <div className="p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl border border-blue-200 dark:border-blue-800">
              ...
              <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                <li className="flex items-center space-x-2">
                  ...
                  <span>Passion-driven projects</span>
                </li>
                <li className="flex items-center space-x-2">
                  <Code className="w-4 h-4 text-green-500 dark:text-green-400" />
                  <span>Learning progress & challenges</span>
                </li>
                <li className="flex items-center space-x-2">
